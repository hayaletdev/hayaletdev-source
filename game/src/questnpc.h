#ifndef __INC_QUEST_NPC__
#define __INC_QUEST_NPC__
...
namespace quest
{
	...
	public:
		...
		bool OnRestartHere(PC& pc);
#endif
#if defined(__QUEST_REQUEST_EVENT__)
		bool OnRequestEvent(PC& pc, DWORD quest_index, int state);
#endif
