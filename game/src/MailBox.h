...
public:
	...
	static void SendGMMail(const char* const cPlayerName, const char* const cTitle, const char* const cMessage, const DWORD dwItemVnum, const DWORD dwItemCount = 1, const int iYang = 0, const int iWon = 0);
