#ifndef __INC_CHARACTER_MANAGER_H__
#define __INC_CHARACTER_MANAGER_H__
...
typedef std::unordered_map<DWORD, LPCHARACTER> pkCharMap;
...
#endif // __INC_CHARACTER_MANAGER_H__
