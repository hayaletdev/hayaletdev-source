...
namespace quest
{
	...
	void RegisterQuestFunctionTable()
	{
		luaL_reg quest_functions[] =
		{
			...
			/*
				NOTE : If it's necessary to check a player's quest flag using other_pc_block,
				be careful when using `pc.getqf`, the current quest may be changed on other players.
				Always rely on using `pc.getf`! 20231214.Owsap
