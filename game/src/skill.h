#ifndef __INC_SKILL_MANAGER_H__
#define __INC_SKILL_MANAGER_H__
...
enum ESkillBookType
{
	SKILL_BOOK_TYPE_SUPPORT,
	SKILL_BOOK_TYPE_WARRIOR,
	SKILL_BOOK_TYPE_ASSASSIN,
	SKILL_BOOK_TYPE_SURA,
	SKILL_BOOK_TYPE_SHAMAN,
	SKILL_BOOK_TYPE_HORSE,
	SKILL_BOOK_TYPE_PASSIVE,
	SKILL_BOOK_TYPE_WOLFMAN,
	SKILL_BOOK_TYPE_MOUNT_UPGRADE,
};
...
enum ESkillIndexes
{
	...
	SKILL_FINISH = 176, // 피니쉬
	SKILL_ILGWANGPYO = 177, // 일광표
	SKILL_PUNGLOEPO = 178, // 풍뢰포
	SKILL_GEOMAGGWI = 179, // 악귀
	SKILL_MABEOBAGGWI = 180, // 흑마악귀
	SKILL_METEO = 181, // 메테오
	SKILL_CHEONUN = 182, // 천운
	SKILL_ILIPUNGU = 183, // 이리풍우
#endif
...
public:
	...
	POINT_TYPE wPointOn; // 어디에 결과값을 적용 시키는가? (타격치, MAX HP, HP REGEN 등등등)
